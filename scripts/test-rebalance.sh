...
for i in {1..20}; do
    curl -s -X POST http://localhost:8081/api/orders \
        ...
        -d "{\"userId\":\"rebalance_user_$i\",\"productId\":\"product_456\",\"quantity\":1,\"price\":99}" >/dev/null
done
echo "已发送 20 条测试消息"
echo ""
...
echo ""
echo "  # 方式3: 使用 kafka-consumer-groups 重置 offset"
echo "  kafka-consumer-groups.sh --reset-offsets"
echo ""
...
echo "      consumer:"
echo "        properties:"
echo "          partition.assignment.strategy: >-"
echo "            org.apache.kafka.clients.consumer."
echo "            CooperativeStickyAssignor"
echo ""
